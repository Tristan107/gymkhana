...
- `npm test`              # vitest, EXCLUDES lean_ai.test.ts (slow)
...
- `src/game/tests/ai-training-puzzles/`   puzzle text files consumed by `__puzzle_run__.test.ts`
...
- Do NOT add `lean_ai.test.ts` to the default `npm test` run.
